...
const groupNameForSetting = (key: string): string => {
  ...
  if (k.startsWith("ability_")) return k.endsWith("_private") ? "Ability Checks Private" : "Ability Checks Blind";
...
const PAIRED_GROUPS: readonly [string, string][]     = Object.freeze([["Skills Blind","Skills Private"],["Ability Checks Blind","Ability Checks Private"],["Saving Throws Blind","Saving Throws Private"],["Fast Forward GM","Fast Forward Player"]]) as readonly [string, string][];
const PAIRED_HEADER_KEYS: Readonly<Record<string, PairedHeaderDef>> = Object.freeze({ "Skills Blind": { left: "enabled", right: "blindRollersChat" }, "Ability Checks Blind": { left: "abilityChecksEnabled", right: "blindRollersAbilityChat" }, "Saving Throws Blind": { left: "savesEnabled", right: "blindRollersSaveChat" } });
