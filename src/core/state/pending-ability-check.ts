...
export const setPendingAbilityCheck = (abilityId: string, userId: string | null = null, actorId: string | null = null): void => {
  if (!abilityId) return;
...
export const peekPendingAbilityCheck = (userId: string | null = null, actorId: string | null = null): string | null => {
  pruneExpired();
...
export const clearPendingAbilityCheck = (abilityId: string | null | undefined, userId: string | null = null, actorId: string | null = null): void => {
  const uid = userId || currentUserId();
  if (abilityId) {
...
export const clearPendingAbilityChecksForActor = (userId: string | null = null, actorId: string | null = null): void => {
  const uid = userId || currentUserId();
  for (const [key, entry] of _pending) {
