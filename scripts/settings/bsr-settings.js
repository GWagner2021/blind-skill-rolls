...
(() => {
  ...
  globalThis.BSR.getThemeStyles = (theme) => {
    const isLight = theme === "light";

    if (isLight) {
      return `
        .bsr-theme { background: var(--color-bg-option, #f0f0e0) !important; }
        ...
        .bsr-theme .window-header .window-title { color: var(--color-text-dark-primary, #000) !important; }
        .bsr-theme .form-group { background: transparent !important; }
        .bsr-theme legend { color: var(--color-text-dark-primary, #000) !important; }
        .bsr-theme .hint { color: var(--color-text-dark-secondary, #4b4a44) !important; }
        .bsr-theme label { color: var(--color-text-dark-primary, #000) !important; }
        .bsr-theme input[type="text"], .bsr-theme input[type="checkbox"], .bsr-theme select {
          background: #fff !important;
          color: #000 !important;
          border: 1px solid #999 !important;
        }
        .bsr-theme fieldset { border: 1px solid #999; }
        .bsr-theme button {
          background: #e0e0d0;
          color: #000;
          border: 1px solid #999;
        }
        .bsr-theme button:hover { background: #d0d0c0; }
      `;
    }

    return `
      .bsr-theme { background: rgba(11,10,19,0.9) !important; }
      .bsr-theme .window-content {
      ...
      .bsr-theme .window-header .window-title { color: #f0f0f0 !important; }
      .bsr-theme .form-group { background: transparent !important; }
      .bsr-theme legend { color: #f0f0f0 !important; font-weight: 600; }
      .bsr-theme .hint { color: #999999 !important; }
      .bsr-theme label { color: #f0f0f0 !important; }
      .bsr-theme input[type="text"], .bsr-theme input[type="checkbox"], .bsr-theme select {
        background: #2a3139 !important;
        color: #f0f0f0 !important;
        border: 1px solid #3d4654 !important;
      }
      .bsr-theme select option { background: #2a3139; color: #f0f0f0; }
      .bsr-theme fieldset { border: 1px solid #3d4654; }
      .bsr-theme button {
        background: #2a3139;
        color: #f0f0f0;
